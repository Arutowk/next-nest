...
export type GetPostByIdQuery = { getPostById: { id: number, title: string, slug: string | null, thumbnail: string | null, content: string, createdAt: Date, updatedAt: Date, publishedAt: Date | null, published: boolean, author: { name: string }, tags: Array<{ id: number, name: string }> } };
